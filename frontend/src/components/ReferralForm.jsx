  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-7">
      <div className="flex flex-col gap-8 lg:flex-row">
        {/* Left Column: Referral Essentials */}
        <div className="flex-1 space-y-5">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <Field label="Date Requested *">
              <TextInput required type="date" placeholder="10 May 2026" value={form.date} onChange={(value) => update("date", value)} />
            </Field>
        ...
        <div className="flex-1 space-y-5">
          <Field label="Notes">
            <TextArea rows={10} placeholder="Context, intro message, follow-up notes..." value={form.notes} onChange={(value) => update("notes", value)} />
          </Field>
        </div>
      </div>
