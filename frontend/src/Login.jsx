      ...
      <div className="w-full max-w-4xl animate-fade-in-up">
        ...
        <div className="saas-card overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-10 lg:p-14 flex flex-col justify-center bg-white">
            ...
            <p className="text-gray-500 mb-8 font-light">Sign in to your workspace to continue.</p>
            ...
            <p className="text-sm text-gray-500 text-center mt-8 font-light">
              ...
              <Link to="/signup" className="text-gray-900 font-medium hover:underline">Sign up for free</Link>
            </p>
          </div>
