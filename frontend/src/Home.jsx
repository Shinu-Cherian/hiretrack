        ...
        <div className="relative max-w-[1600px] mx-auto w-full grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left z-10">
            <div className="animate-fade-in-up">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 bg-white/80 backdrop-blur-sm text-gray-600 text-sm font-medium shadow-sm mb-6 shimmer-container">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 leading-tight">
              ...
              <br />
              <span className="text-gradient-modern animate-fade-in-up" style={{ animationDelay: "400ms" }}>with precision.</span>
            </h1>

            <p className="mt-6 text-xl text-gray-500 max-w-xl mx-auto lg:mx-0 animate-fade-in-up delay-500 font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" onClick={(e) => openModal(e, 'about')} className="hover:text-gray-900 dark:hover:text-white transition-colors">About Us</a></li>
                <li><a href="#" onClick={(e) => openModal(e, 'faq')} className="hover:text-gray-900 dark:hover:text-white transition-colors">FAQ</a></li>
              </ul>
            </div>

            {/* Legal */}
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-4">Legal Links</h4>
              <ul className="space-y-3 text-sm">
                <li><a href="#" onClick={(e) => openModal(e, 'privacy')} className="hover:text-gray-900 dark:hover:text-white transition-colors">Privacy Policy</a></li>
                <li><a href="#" onClick={(e) => openModal(e, 'terms')} className="hover:text-gray-900 dark:hover:text-white transition-colors">Terms of Use</a></li>
              </ul>
            </div>

            {/* Social */}
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-4">Follow Us</h4>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-400 hover:text-gray-900 dark:hover:text-white hover:border-gray-300 transition-all shadow-sm">
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      {[...Array(12)].map((_, i) => {
        ...
        return (
          <div
            key={i}
            className="absolute animate-float opacity-[0.05] dark:opacity-[0.08]"
            style={{
              left: `${left}%`,
              top: `${top}%`,
