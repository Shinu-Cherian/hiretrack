...
const features = [
  { icon: Sparkles, title: 'Smart Insights', desc: 'Automatic suggestions on follow-ups, response rates and where to focus next..' },
  { icon: ShieldCheck, title: 'Private by Default', desc: 'Your data stays on your device. No tracking, no third-party sharing.' },
  { icon: Zap, title: 'Lightning Fast', desc: 'A snappy, modern interface built to capture an application in under 30 seconds.' },
];
...
export default function Home() {
  ...
  return (
    <div className="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden h-screen snap-start flex flex-col justify-center items-center text-center bg-gradient-subtle">
        ...
        <p className="mt-4 text-gray-600 animate-fade-in-up max-w-xl">
      ...
      {/* MODULES */}
      <section className="h-screen snap-start flex items-center py-20 px-6">
      ...
      {/* FEATURES */}
      <section className="h-screen snap-start flex items-center py-20 px-6 bg-gray-50">
        <div className="w-full">
          <h2 className="text-3xl font-bold text-center mb-12">
      ...
      {/* ABOUT */}
      <section className="h-screen snap-start flex items-center py-24 px-6">
