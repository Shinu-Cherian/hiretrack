import { Star, Bell, Settings, LogOut, Archive, ArrowRight, Edit, Puzzle } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                <h3 className="font-black text-white truncate text-lg tracking-widest drop-shadow-none shadow-none" style={{ textShadow: 'none' }}>
                  {username}
                </h3>
                <p
                  onClick={() => {
